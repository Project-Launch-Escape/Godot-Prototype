...
public partial class TransformTracker : Control
{
	...
	public override void _Ready()
	{
		...
		{
			Scale = Vector2.One * ScaleAtCoordLayer[(int)celestial.RelPosition.CoordLayer];
		}
	}
	...
	public override void _Process(double delta)
	{
		...
		if (behind) return;
		Position = _camera.UnprojectPosition(_toTrack.GlobalPosition - _camera.GlobalPosition);
	}
}
